...
下载地址：[https://github.com/prometheus/prometheus/releases/download/v2\.26\.0/prometheus\-2\.26\.0\.linux\-amd64\.tar.gz](https://github.com)
...
有关配置选项的完整说明，请参阅[配置文档](https://github.com)。
...
还可以通过访问到其 metrics endpoint（[http://localhost:9090/metrics）](https://github.com) 来验证 Prometheus 是否正在提供有关其自身的 metrics
...
更多有关 expression language 的更多信息，请查看 [expression language 文档](https://github.com):[milou云加速器官网](https://jiechuangmoxing.com)。
...
使用`Node Exporter`作为采样目标，多关于它的使用[请查阅](https://github.com)
...
[https://www.kancloud.cn/nicefo71/prometheus\-doc\-zh/1331204](https://github.com)


[https://prometheus.io/docs/prometheus/latest/getting\_started/](https://github.com)
